...
[TIP]
====
👉 这里面很奇怪，mirror maker 和 mirror maker 2 是什么关系，有什么联系？ 官方文档在这里： https://access.redhat.com/documentation/en-us/red_hat_amq_streams/2.1/html-single/amq_streams_on_openshift_overview/index#configuration-points-topic_str
